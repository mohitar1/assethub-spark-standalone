...
// Brand-derived chart palette — built around the Heineken theme (green --primary-color
// #097E2C, red --color-red #E3000F) plus harmonious supporting tones, so charts
// match the rest of the app instead of using a generic/Google default palette.
// Primary green is reserved for `download` (the dominant action in this report).
const BRAND_SEQUENCE = [
  '#097E2C', // brand green (primary)
  '#B4000C', // deep red
  '#51A025', // warm olive
  '#E3000F', // brand red (accent)
  '#3DA35B', // light green
  '#6E7E5B', // sage
  '#8A6D3B', // bronze
  '#4F6472', // slate
...
const PALETTE = {
  download: '#097E2C', // primary green — dominant action
  view: '#3DA35B', // light green
  'share-link-copy': '#51A025', // warm olive
  'dm-url-copy': '#B4000C', // deep red
  'collection-add': '#E3000F', // brand red
  internal: '#097E2C',
  external: '#3DA35B',
