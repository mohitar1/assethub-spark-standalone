...
| `collections-auto-after-assets` | Step 6 runs automatically once assets are searchable (immediately or on a deferred-enrichment resume); the agent does not stop at asset/search verification | Step 6 | no fixture |
