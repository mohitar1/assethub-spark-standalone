...
The controller `.claude/skills/rebrand-portal/scripts/assets/enrich-assets.js` resolves credentials from
...
- The agent runs the asset enrichment via `.claude/skills/rebrand-portal/scripts/assets/enrich-assets.js`
