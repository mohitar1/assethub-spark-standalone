...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#0067B8');
      expect(ROLE_COLORS.Agency).toBe('#FFB900');
      expect(ROLE_COLORS.Partner).toBe('#201F1E');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#0067B8');
      expect(getRoleColor('Agency')).toBe('#FFB900');
      expect(getRoleColor('Partner')).toBe('#201F1E');
