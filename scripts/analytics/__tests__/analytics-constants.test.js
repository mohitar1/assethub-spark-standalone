...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#101319');
      expect(ROLE_COLORS.Agency).toBe('#9AA3B1');
      expect(ROLE_COLORS.Partner).toBe('#5A5F68');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#101319');
      expect(getRoleColor('Agency')).toBe('#9AA3B1');
      expect(getRoleColor('Partner')).toBe('#5A5F68');
