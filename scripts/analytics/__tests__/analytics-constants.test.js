...
describe('analytics-constants', () => {
  ...
  describe('ROLE_COLORS', () => {
    it('has colors for all known roles and Other', () => {
      expect(ROLE_COLORS.Associate).toBe('#0093D0');
      expect(ROLE_COLORS.Agency).toBe('#7FC4E8');
      expect(ROLE_COLORS.Partner).toBe('#0B1E33');
  ...
  describe('getRoleColor', () => {
    it('returns correct colors for known roles', () => {
      expect(getRoleColor('Associate')).toBe('#0093D0');
      expect(getRoleColor('Agency')).toBe('#7FC4E8');
      expect(getRoleColor('Partner')).toBe('#0B1E33');
